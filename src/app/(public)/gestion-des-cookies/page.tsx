...
export default function GestionDesCookies() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[25%] md:pt-[10%] pb-10 font-inclusive text-dark">
      <div>
        <h1 className="text-4xl font-bold font-tango">Gestion des cookies</h1>
        <span className="italic text-xs">
          Dernière mise à jour : 03/01/2026
        </span>
        <p className="mt-4 mb-6">
          Ce document vous informe sur l&apos;utilisation des cookies sur le
          site Remindr et sur les moyens dont vous disposez pour les gérer,
          conformément à la réglementation en vigueur et à nos engagements en
      ...
      <p className="mb-4">
        ...
        permet de mémoriser des informations sur votre navigation (préférences,
        session, statistiques, etc.) pour une durée limitée.
      </p>
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li className="mb-2">
          <strong>Cookies de performance et d&apos;analyse :</strong> nous
          aident à comprendre comment les visiteurs utilisent le site (pages
          vues, durée, parcours) afin d&apos;améliorer nos services.
        </li>
        <li className="mb-2">
          <strong>Cookies de personnalisation :</strong> permettent
          d&apos;adapter l&apos;affichage ou le contenu en fonction de vos choix
          (langue, région, etc.).
        </li>
      </ul>
      ...
      <p className="mb-4">
        ...
        session sont supprimés à la fermeture du navigateur. D&apos;autres
        cookies peuvent être conservés pendant une durée définie (par exemple 12
        ou 24 mois) pour les besoins d&apos;analyse ou de personnalisation.
      </p>
      ...
      <ul className="list-disc pl-6 mb-4">
        <li className="mb-2">
          Via les paramètres de votre navigateur (refus ou suppression des
          cookies). Les modalités varient selon les navigateurs (Chrome,
